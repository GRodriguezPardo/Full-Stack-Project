    ...
    create table PosibleCaracteristica (
        id bigint generated by default as identity (start with 1),
        nombreCaracteristica varchar(255),
        primary key (id)
    )
    ...
    create table RepositorioDeCaracteristicas_PosibleCaracteristica (
        RepositorioDeCaracteristicas_id bigint not null,
    ...
    alter table RepositorioDeCaracteristicas_PosibleCaracteristica 
        add constraint UK_1h6ls945nkvl5j0sakwdd15y6  unique (posiblesCaracteristicas_id)
    ...
    alter table RepositorioDeCaracteristicas_PosibleCaracteristica 
        add constraint FK_1h6ls945nkvl5j0sakwdd15y6 
        foreign key (posiblesCaracteristicas_id) 
        references PosibleCaracteristica

    alter table RepositorioDeCaracteristicas_PosibleCaracteristica 
        add constraint FK_9q8lf9ccxuuwfrd6oqi9t9232 
        foreign key (RepositorioDeCaracteristicas_id) 
        references RepositorioDeCaracteristicas
